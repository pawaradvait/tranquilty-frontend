...
@Component({
  selector: 'app-use-solved-info',
  templateUrl: './use-solved-info.component.html',
  styleUrls: ['./use-solved-info.component.css'],
})
export class UseSolvedInfoComponent implements OnInit {
  solveddataByUser = [
    {
      id: 707,
      marksObtained: null,
